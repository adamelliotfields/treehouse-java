package io.github.adamelliotfields.flashy.controllers;

import static java.util.stream.Collectors.toList;

import io.github.adamelliotfields.flashy.domain.BootstrapOptions;
...
public class BootstrapController {
  private final String GITHUB_MASTER_REPO_OWNER = "adamelliotfields";
  private final String GITHUB_MASTER_REPO_NAME = "treehouse-java";
  ...
  public void bootstrapRepo(WorkLog workLog, String gitHubUserName) throws IOException {
    ...
    try {
      ...
      Repository masterRepo = repositoryService.getRepository(GITHUB_MASTER_REPO_OWNER, GITHUB_MASTER_REPO_NAME);
